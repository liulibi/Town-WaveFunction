...
public class Click : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerActions.Build.Add.performed += Add;
        playerActions.Build.Delete.performed += Delete;
    }
    ...
    public void FindTarget()
    {
        ...
        if (Physics.Raycast(ray, out raycastHit, rayCostRange, clickLayerMask))
        {
    ...
    private void Delete(UnityEngine.InputSystem.InputAction.CallbackContext obj)
    {
    ...
    private void Add(UnityEngine.InputSystem.InputAction.CallbackContext obj)
    {
